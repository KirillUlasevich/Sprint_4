...
public class faqTest extends BaseTest {
    ...
    public faqTest(String questionNumber, String answerNumber, String expected) {
    ...
    @Test
    public void checkFaqButtonText() {
        MainPage mainPage = new MainPage(driver)
                .clickAcceptCookiesButton()
                .scrollToFaq()
                .clickButton(questionNumber);
        mainPage.getText(answerNumber);
        String actual = mainPage.getText(answerNumber);
